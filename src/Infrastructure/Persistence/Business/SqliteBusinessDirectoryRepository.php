...
class SqliteBusinessDirectoryRepository implements BusinessDirectoryRepository
{
    ...
    public function findBusinessesWithActiveOffers(): array
    {
        $statement = $this->pdo->query(
            "SELECT users.id, users.email, users.role, users.business_name, users.whatsapp, users.logo_url, users.cover_url, users.created_at,
             ...
             GROUP BY users.id, users.email, users.role, users.business_name, users.whatsapp, users.logo_url, users.cover_url, users.created_at
